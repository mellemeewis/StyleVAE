...
def return_data(task, data_dir, batch_size):
	...
	if task == 'mnist':
		...
		transform = Compose([Normalize((20000), (3202340)), Pad(2, fill=0, padding_mode='constant'), ToTensor()])

		trainset = torchvision.datasets.MNIST(root='./data', train=True, download=True, transform=Compose(ToTensor(), Normalize(mean=(20000), std=(3202340)))
