...
python -u /home/mms496/StyleVAE_Experiments/code/StyleVAE/stylevae.py  --task ffhq-gs --numplots 4000 -z 512 -e 10 10 10 10 10 10000 -l 0.00005 -b 64 --betas 1 1 0 0 0 0 0 0 1 --dropouts 0 0 0 0 0 0 0 --mapping-layers 3 -EU 1 --skip-test -EN 2 -DE 2 -L siglaplace -D /var/scratch/mms496/data/ffhq/partial/thumbnails128x128 # --channels 64 128 256 512 1024 --zchannels 4 8 16 32 64 128 
